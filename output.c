...
mar_Nothing mar_dump_bo_StdoutWriter_bc__po_U8_c_StdoutWriter_pc_(mar_U8 arg0, mar_StdoutWriter arg1) {
  ...
  expr_2: mar_I64 _2; _2.value = 100;
  expr_3: mar_U8 _3 = mar_to__U8_po_I64_pc_(_2);
  expr_4: mar_U8 _4 = mar_divide_po_U8_c_U8_pc_(_0, _3);
  expr_5: mar_I64 _5; _5.value = 10;
  expr_6: mar_U8 _6 = mar_to__U8_po_I64_pc_(_5);
  expr_7: mar_U8 _7 = mar_modulo_po_U8_c_U8_pc_(_4, _6);
  expr_8: mar_I64 _8; _8.value = 48;
  expr_9: mar_U8 _9 = mar_to__U8_po_I64_pc_(_8);
  expr_10: mar_U8 _10 = mar_add_po_U8_c_U8_pc_(_7, _9);
  expr_11: mar_Nothing _11 = mar_write_po_StdoutWriter_c_U8_pc_(_1, _10);
  expr_12: mar_I64 _12; _12.value = 10;
  expr_13: mar_U8 _13 = mar_to__U8_po_I64_pc_(_12);
  expr_14: mar_U8 _14 = mar_divide_po_U8_c_U8_pc_(_0, _13);
  expr_15: mar_I64 _15; _15.value = 10;
  expr_16: mar_U8 _16 = mar_to__U8_po_I64_pc_(_15);
  expr_17: mar_U8 _17 = mar_modulo_po_U8_c_U8_pc_(_14, _16);
  expr_18: mar_I64 _18; _18.value = 48;
  expr_19: mar_U8 _19 = mar_to__U8_po_I64_pc_(_18);
  expr_20: mar_U8 _20 = mar_add_po_U8_c_U8_pc_(_17, _19);
  expr_21: mar_Nothing _21 = mar_write_po_StdoutWriter_c_U8_pc_(_1, _20);
  expr_22: mar_I64 _22; _22.value = 10;
  expr_23: mar_U8 _23 = mar_to__U8_po_I64_pc_(_22);
  expr_24: mar_U8 _24 = mar_modulo_po_U8_c_U8_pc_(_0, _23);
  expr_25: mar_I64 _25; _25.value = 48;
  expr_26: mar_U8 _26 = mar_to__U8_po_I64_pc_(_25);
  expr_27: mar_U8 _27 = mar_add_po_U8_c_U8_pc_(_24, _26);
...
mar_Nothing mar_dump_bo_U8_c_StdoutWriter_bc__po_Maybe_bo_U8_bc__c_StdoutWriter_pc_(mar_Maybe_bo_U8_bc_ arg0, mar_StdoutWriter arg1) {
  ...
  expr_6: mar_I64 _6; _6.value = 115;
  expr_7: mar_U8 _7 = mar_to__U8_po_I64_pc_(_6);
  expr_8: mar_Nothing _8 = mar_write_po_StdoutWriter_c_U8_pc_(_1, _7);
  expr_9: mar_I64 _9; _9.value = 111;
  expr_10: mar_U8 _10 = mar_to__U8_po_I64_pc_(_9);
  expr_11: mar_Nothing _11 = mar_write_po_StdoutWriter_c_U8_pc_(_1, _10);
  expr_12: mar_I64 _12; _12.value = 109;
  expr_13: mar_U8 _13 = mar_to__U8_po_I64_pc_(_12);
  expr_14: mar_Nothing _14 = mar_write_po_StdoutWriter_c_U8_pc_(_1, _13);
  expr_15: mar_I64 _15; _15.value = 101;
  expr_16: mar_U8 _16 = mar_to__U8_po_I64_pc_(_15);
  expr_17: mar_Nothing _17 = mar_write_po_StdoutWriter_c_U8_pc_(_1, _16);
  expr_18: mar_I64 _18; _18.value = 40;
  expr_19: mar_U8 _19 = mar_to__U8_po_I64_pc_(_18);
  ...
  expr_22: mar_I64 _22; _22.value = 41;
  expr_23: mar_U8 _23 = mar_to__U8_po_I64_pc_(_22);
  ...
  expr_27: mar_I64 _27; _27.value = 110;
  expr_28: mar_U8 _28 = mar_to__U8_po_I64_pc_(_27);
  expr_29: mar_Nothing _29 = mar_write_po_StdoutWriter_c_U8_pc_(_1, _28);
  expr_30: mar_I64 _30; _30.value = 111;
  expr_31: mar_U8 _31 = mar_to__U8_po_I64_pc_(_30);
  expr_32: mar_Nothing _32 = mar_write_po_StdoutWriter_c_U8_pc_(_1, _31);
  expr_33: mar_I64 _33; _33.value = 110;
  expr_34: mar_U8 _34 = mar_to__U8_po_I64_pc_(_33);
  expr_35: mar_Nothing _35 = mar_write_po_StdoutWriter_c_U8_pc_(_1, _34);
  expr_36: mar_I64 _36; _36.value = 101;
  expr_37: mar_U8 _37 = mar_to__U8_po_I64_pc_(_36);
  expr_38: mar_Nothing _38 = mar_write_po_StdoutWriter_c_U8_pc_(_1, _37);
...
mar_I64 mar_main_po__pc_() {
  expr_0: mar_I64 _0; _0.value = 2;
  expr_1: mar_U8 _1 = mar_to__U8_po_I64_pc_(_0);
  expr_2: mar_Maybe_bo_U8_bc_ _2; _2.variant = mar_some; _2.as.mar_some = _1;
  expr_3: mar_Nothing _3 = mar_println_bo_Maybe_bo_U8_bc__bc__po_Maybe_bo_U8_bc__pc_(_2);
  expr_4: mar_I64 _4; _4.value = 0;
  expr_5: return _4; mar_Never _5;
  expr_6: mar_I64 _6; _6.value = 3;
  expr_7: mar_I64 _7; _7.value = 4;
  expr_8: mar_I64 _8 = mar_add_po_I64_c_I64_pc_(_6, _7);
  expr_9: mar_I64 _9; _9.value = 4;
  expr_10: mar_I64 _10; _10.value = 2;
  expr_11: mar_I64 _11 = mar_divide_po_I64_c_I64_pc_(_9, _10);
  expr_12: mar_I64 _12 = mar_multiply_po_I64_c_I64_pc_(_8, _11);
  expr_13: mar_I64 _13; _13.value = 10;
  expr_14: mar_I64 _14 = mar_modulo_po_I64_c_I64_pc_(_12, _13);
  expr_15: return _14; mar_Never _15;
  expr_16: // end
}
...
mar_Nothing mar_println_bo_Maybe_bo_U8_bc__bc__po_Maybe_bo_U8_bc__pc_(mar_Maybe_bo_U8_bc_ arg0) {
  ...
  expr_3: mar_I64 _3; _3.value = 10;
  expr_4: mar_U8 _4 = mar_to__U8_po_I64_pc_(_3);
  expr_5: mar_Nothing _5 = mar_write_po_StdoutWriter_c_U8_pc_(_2, _4);
  expr_6: // end
  return _5;
}
